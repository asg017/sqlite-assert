...
envsubst < bindings/elixir/sqlite-assert-checksum.exs.tmpl > bindings/elixir/sqlite-assert-checksum.exs
echo "✅ generated bindings/elixir/sqlite-assert-checksum.exs"
